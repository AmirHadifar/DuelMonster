...
import ir.ac.aut.ceit.world.Player;
...
public class DuelMonsters {
    ...
    /**
     * DuelMonsters entry point for the program.
     *
     * @param args unused.
     */
    ...
    private static void playerPlayCard() {
        System.out.println("Type in the number of the card you want to play");
        ...
        } else if (selection == player.getHand().length && player.getNextSpecial() != null) {
    ...
    private static void playerAttackCard() {
        System.out.println("Type in the number of the card you want to attack with");
        int myMonster = input.nextInt() - 1;
        System.out.println("Type in the number of the enemy card you want to attack");
        ...
        if (myMonster >= 0 && enemyMonster >= 0
            ...
            if (success) {
                cpu.changeLifePoints(
                        cpuField.getMonsters()[enemyMonster].getPower() - playerField.getMonsters()[myMonster].getPower());
                cpuField.getMonsters()[enemyMonster] = null;
